  ...
  <div class="p-4 md:p-10">
    <div class="md:flex mt-20 text-center">
      <div class="mx-auto md:w-2/3 text-gray-900 dark:text-gray-300">
        <h1 class="font-bold text-2xl mb-10 uppercase">TIMELINE</h1>
        ...
        <div class="relative mt-5 text-left dark:text-gray-400">
          <div class="flex items-center relative" data-aos="fade-up">
            ...
            <div class="ml-10">
              ...
              <div class="mb-10">
                Suspendisse convallis nunc non tempus interdum. Class aptent
                taciti sociosqu ad litora torquent per conubia nostra, per
                inceptos himenaeos. Aliquam vel fringilla ante, eu molestie
                mauris. Sed nisi est, imperdiet eget convallis ac, aliquet a mi.
              </div>
            </div>
          </div>
          <div class="flex items-center relative" data-aos="fade-up">
            ...
            <div class="ml-10">
              ...
              <div class="mb-10">
                "timeline_desc": "Suspendisse convallis nunc non tempus
                interdum. Class aptent taciti sociosqu ad litora torquent per
                conubia nostra, per inceptos himenaeos. Aliquam vel fringilla
                ante, eu molestie mauris. Sed nisi est, imperdiet eget convallis
                ac, aliquet a mi.",
              </div>
            </div>
          </div>
